...
/**
 * SetupSinglePlayerActivity is a controller class that manages what topics are selected and
 ...
 */
public class SetupSinglePlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.d("IncidentTrafficker", "IN SETUP ACTIVITY");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_single_setup);
        ...
        begin.setOnClickListener(new View.OnClickListener() {//Launch Single Player activity
            @Override
            public void onClick(View view) {
                name = playerNameBox.getText().toString();

                launchSinglePlayerQuizbowlActivity();
            }
        });
     ...
     */
    private void launchSinglePlayerQuizbowlActivity() {
        ...
        //for now:
        Intent intent = new Intent(this, SinglePlayerQuizBowlActivity.class);
        ...
        if(addHistory || addLit || addArt || addCurrEvents || addPopCult || addScience) {
            ...
            if (addEasy || addMedium || addHard) {
                ...
                String name = playerNameBox.getText().toString();
